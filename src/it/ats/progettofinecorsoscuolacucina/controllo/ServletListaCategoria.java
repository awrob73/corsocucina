...
/**
 * Servlet implementation class ServletListaCategoria
 */
public class ServletListaCategoria extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			lista = scat.cercaTutteCategorie();
			
			request.setAttribute("listaCategoria", lista);
			getServletContext().getRequestDispatcher("/WEB-INF/listaCategoria.jsp").forward(request, response);
